...
# To use python-multipart (required for form handling with FastAPI), add the following line in your requirements.txt file:
# python-multipart
# If you are installing via pip, run:
...
async def exam(
    ...
    pages = [
        {
            "name": "Daily % Change",
            "desc": """
                <div style="font-size: 1.22rem; color: #222; font-family: 'Segoe UI', Calibri, Arial, sans-serif; line-height:1.65;">
                    <strong style="font-size:1.27em;">You are provided with a professional stock data table, including <b>Open</b> and <b>Close</b> prices for each stock.</strong>
                    <br><br>
                    <span style="font-size: 1.10em;">
                        <b>Your Task:</b> Determine the percentage change from the opening to closing price for each stock. 
                        Please input the calculated value in the <span style="background: #f3f2f1; color:#197600; padding:1px 8px; border-radius:4px; font-weight:600;">Daily % Change</span> column (highlighted for reference).
                    </span>
                    <br><br>
                    <span style="color:#334155;font-size:1.07em; font-weight:500;">
                        <i class="fas fa-lightbulb" style="color:#f59e42;margin-right:3px;"></i>
                        For a seamless workflow, enter your answer for the first row, then utilize the <span style="color:#2563eb;font-weight:700;">fill handle</span> to extend your formula down the column—just like in Excel. This ensures accuracy and saves time across all entries.
                    </span>
                    <br>
                    <span style="color:#e09f18;font-size:1.03em; font-weight:600;">
                        <i class="fas fa-mouse-pointer" style="color:#b2850b;margin-right:2px;"></i>
                        Tip: Double-click the fill handle to instantly complete the calculation for the entire column.
                    </span>
                </div>
            """,
        ...
        {
            "name": "Day Range - High and Low ",
            "desc": """
                <div style="font-size: 1.15rem; color: #222; font-family: 'Segoe UI', Calibri, Arial, sans-serif; line-height:1.65;">
                    <strong style="font-size:1.18em;">Determine the day range for each stock.</strong>
                    <br><br>
                    <span style="font-size: 1.07em;">
                        Focus on the highlighted <span style="background: #f3f2f1; color:#28519b; padding:1px 8px; border-radius:4px; font-weight:600;">Day Range</span> column and enter your calculated result for each row.
                    </span>
                    <br><br>
                    <span style="color:#334155;font-size:1.06em;font-weight:500;">
                        Quickly and efficiently complete the entire column by inputting your answer for the first row and then dragging the fill handle down to propagate it to the remaining rows—just like in Excel.
                    </span>
                    <br>
                    <span style="color:#e09f18;font-size:1.03em; font-weight:600;">
                        Double-click the fill handle to instantly apply your calculation to all rows below, saving time and ensuring accuracy across your entries.
                    </span>
                </div>
            """,
        ...
        { # =IF(G3>250000,"High Volume","Normal Volume")
            "name": "High Volume Check (IF Formula)",
            "desc": """
                <div style="font-size: 1.17rem; color: #203040; font-family: 'Segoe UI', Calibri, Arial, sans-serif; line-height:1.7; padding-bottom:5px;">
                    <strong style="font-size:1.25em; color: #1976d2;">Professional Task: Classify Stock Volume</strong>
                    <br><br>
                    <span style="font-size: 1.08em;">
                        Review the <span style="font-weight:bold; color:#2a4686;">Volume</span> for each stock and determine if the trading volume qualifies as "<span style="color:#257900; font-weight:600;">High Volume</span>" or "<span style="color:#697389;">Normal Volume</span>".<br>
                        Enter your classification in the <span style="background:#f3f2f1; color:#28519b; padding:1px 9px; border-radius:4px; font-weight:600;">High Volume</span> column for every row.
                    </span>
                    <br><br>
                    <ul style="margin-left:30px; font-size:1.06em; color:#27384a;">
                        <li>
                            Label as <span style="color:#217346; font-weight:bold;">High Volume</span> if the stock’s volume exceeds <b>250,000</b>.
                        </li>
                        <li>
                            Label as <span style="color:#697389; font-weight:bold;">Normal Volume</span> if the volume is <b>250,000 or less</b>.
                        </li>
                    </ul>
                    <div style="margin-top:9px; color:#304c7a; font-size:1.04em;">
                        Please be thoughtful and accurate—your classifications should reflect the specified criteria above.
                    </div>
                    <div style="margin-top:14px; color:#e0aa11; font-size:1.025em; font-weight:600;">
                        <i class="fas fa-lightbulb" style="color:#e8b009;margin-right:4px;"></i>
                        Professional Tip: Enter your answer for the first row, then drag the fill handle down the column to apply your logic quickly and consistently to all rows. Make sure each entry is correct before submitting.
                    </div>
                </div>
            """,
            "column_title": "High Volume",
            "col_idx": 10,  # New column for High Volume after last index 10 (Signal)
            "placeholder": 'Enter IF() formula...',
            "excelCheckFunc": "highVolumeCheck",
            "cell_class": "cell-input highvolume-input"
        },
        {# =IF(C3<F3,"BUY",IF(C3>F3,"SELL","NEUTRAL"))
            "name": "Signal (BUY/SELL/NEUTRAL): Excel IF Formula",
            "desc": """
            <div style="font-size: 1.17rem; color: #203040; font-family: 'Segoe UI', Calibri, Arial, sans-serif; line-height:1.7; padding-bottom:5px;">
                <strong style="font-size:1.23em; color: #188a1b;">Professional Task: Signal Classification</strong>
                <br><br>
                <span style="font-size: 1.08em;">
                    Carefully review the <span style="color:#197600; font-weight:600;">Signal</span> column for each stock entry. 
                    Your objective is to determine whether the trade should be classified as <span style="color:green; font-weight:bold;">BUY</span>, <span style="color:#b80000; font-weight:bold;">SELL</span>, or <span style="color:#7e7e00; font-weight:bold;">NEUTRAL</span> based on a comparison of the <b>Open</b> and <b>Close</b> prices.<br>
                </span>
                <br>
                <ul style="margin-left:30px; font-size:1.06em; color:#27384a;">
                    <li>
                        <span style="color:green; font-weight:bold;">BUY</span> when the Open price is less than the Close price.
                    </li>
                    <li>
                        <span style="color:#b80000; font-weight:bold;">SELL</span> when the Open price is greater than the Close price.
                    </li>
                    <li>
                        <span style="color:#7e7e00; font-weight:bold;">NEUTRAL</span> when the Open and Close prices are equal.
                    </li>
                </ul>
                <div style="margin-top:12px; color:#304c7a; font-size:1.045em;">
                    Input your classification for every row, following the logic above. Ensure accuracy and consistency throughout your entries.
                </div>
                
            </div>
            """,
            "column_title": "Signal",
            "col_idx": 11,   # New column for Signal (after last index 9)
            "placeholder": 'Enter IF() formula...',
    ...
    # Replace your existing `table_html` section with this complete version
    ...
    if q in (1, 2):
        ...
        for i, row in enumerate(DATA[1:], start=2):
            ...
            for col_index, cell in enumerate(row):
                cell_style = (
                    "background:#fffbe5;"
                    if (q == 1 and col_index == 8)
                    or (q == 2 and col_index == 9)
                    else "background:#ffffff;"
                )

                if col_index == col_input_index:
                    table_html += f"""
                    <td style="padding:0 1px;vertical-align:middle;{cell_style}position:relative;">
                        <div style="display:flex;align-items:center;position:relative;">
                            <input type='text'
                                ...
                                data-row='{i}'
                                data-col='{col_index}'>
                            <div class="excel-drag-fill"
                                title="Drag/copy formula (dbl-click to fill down)"
                                ...
                                data-row="{i}"
                                data-col="{col_index}"></div>
                        </div>
                    </td>
                    """
                else:
                    table_html += f"""
                    <td style='padding:0 1px;vertical-align:middle;{cell_style}font-family:Calibri,Arial,sans-serif;font-size:11pt;'>
                        {cell}
                    </td>
                    """

            table_html += f"""
            <td id='res_{i}' style='background:{standard_bg};font-family:Calibri,Arial,sans-serif;font-size:11pt;padding:0 5px;'></td>
            </tr>
            """

    elif q == 3:
        col_input_index = page["col_idx"]
        print(col_input_index)
        ...
        for i, row in enumerate(DATA[1:], start=2):
            ...
            for col_index, cell in enumerate(row):
                table_html += f"""
                <td style='padding:0 1px;vertical-align:middle;background:#ffffff;font-family:Calibri,Arial,sans-serif;font-size:11pt;'>
                    {cell}
                </td>
                """

            table_html += f"""
            <td style="padding:0 1px;vertical-align:middle;background:#fffbe5;position:relative;">
                <div style="display:flex;align-items:center;position:relative;">
                    <input type='text'
                        ...
                        autocomplete='off'
                        data-row='{i}'
                        data-col='{col_input_index}'>
                    <div class="excel-drag-fill"
                        title="Drag/copy formula (dbl-click to fill down)"
                        style="width:10px;height:22px;display:inline-block;cursor:crosshair;background:transparent;position:relative;margin-left:2px;"
                        data-row="{i}"
                        data-col="{col_input_index}"></div>
                </div>
            </td>
        ...
        for i, row in enumerate(DATA[1:], start=2):
            ...
            table_html += f"""
            <td style="padding:0 1px;vertical-align:middle;background:{signal_highlight};position:relative;">
                <div style="display:flex;align-items:center;position:relative;">
                    <input type='text'
                        class='{page["cell_class"]} excel-input-sheet'
                        id='input_{i}_{col_input_index}'
    ...
    <style>
        ...
        .excel-table-x tr:hover td,
        .excel-table-x tr:focus-within td {{
            background: #e9f1fe;
            transition: background 0.07s;
        }}
        .excel-table-x input[type="text"],
        .excel-input-sheet {{
            border: none;
            outline: none;
        ...
        .excel-table-x input[type="text"]:focus,
        .excel-input-sheet:focus {{
        ...
        .excel-btn-action:focus {{
            background: #14642b;
            box-shadow: 0 3px 12px #21734620;
        }}
        ...
        .excel-btn-action.reset:hover,
        .excel-btn-action.reset:focus {{
            background: #e9edfa;
            color: #217346;
        }}
        .excel-drag-fill {{
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function processIfFormula(expression) {
            function parseSingleIf(expr) {
                let start = expr.toUpperCase().indexOf('IF(');
                ...
                for (let i = openPos; i < expr.length; i++) {
                    if (expr[i] === '(') depth++;
                    else if (expr[i] === ')') {
                        depth--;
                        if (depth === 0) {
                ...
                let inner = expr.substring(openPos + 1, end);
                let args = splitIfArguments(inner);
                ...
                let trueValue = args[1].trim();
                let falseValue = args[2].trim();

                let jsIf = '((' + condition + ') ? (' + trueValue + ') : (' + falseValue + '))';

                return expr.substring(0, start) + jsIf + expr.substring(end + 1);
            }

            while (/IF\(/i.test(expression)) {
                let updated = parseSingleIf(expression);
                if (updated === expression) break;
                expression = updated;
            }
        ...
        function convertFormula(f, currRowNum) {
            ...
            v = v.replace(/([A-L])([0-9]+)/gi, function(match, letter, baseRow) {
                let baseIdx = colLetterToIdx[letter.toUpperCase()];
                let outRow = parseInt(baseRow, 10);

                if (relOffset !== null) {
                    outRow = outRow + relOffset;
                }

                if (outRow < 2) outRow = 2;
                if (outRow > 13) outRow = 13;

                let cellValue = getCellFromData(outRow - 1, baseIdx);
            ...
            v = v.replace(/ROUND\(([^,]+),([0-9]+)\)/gi, function(match, expr, dec) {
                return '(Math.round((' + expr + ') * Math.pow(10,' + dec + ')) / Math.pow(10,' + dec + '))';
            });

            v = v.replace(/SQRT\(([^)]+)\)/gi, function(match, arg) {
                return 'Math.sqrt(' + arg + ')';
            });

            v = processIfFormula(v);
            ...
            try {
                ...
                if (!code) {
                    ...
                    if (qtype === 1) {
                        ...
                        if (isNaN(userVal)) {
                            msg = "<span class='excel-result-error'>#ERROR TEST 1</span>";
                        } else if (Math.abs(userVal - correctVal) < 0.001) {
                            msg = "<span class='excel-result-success'>&#10004; " + result + "</span>";
                        } else {
                            msg = "<span class='excel-result-warn'>&#9888; " + result + "</span>";
                        }
                    }
                    ...
                    // ---------------- QUESTION 3 ----------------
                        ...
                        let volume = parseFloat(getCellFromData(row, 6));
                        let correctVal = volume > 250000 ? "High Volume" : "Normal Volume";

                        let userVal = (result + "").trim();
                        let formulaVal = (formula + "").trim();
                        ...
                        let formulaNorm = normalize(formulaVal);

                        console.log("Volume:", volume);
                        console.log("Correct:", correctVal);
                        console.log("User Result:", userVal);
                        console.log("Formula:", formulaVal);
                        console.log("Formula Norm:", formulaNorm);

                        if (userVal === "" && formulaVal === "") {
                            msg = "";
                        }

                        else if (userNorm === correctNorm) {
                            msg = "<span class='excel-result-success'>&#10004; " + correctVal + "</span>";
                        }

                        else if (
                            formulaNorm.startsWith("=if(") &&
                            (
                                formulaNorm.includes(">250000") ||
                                formulaNorm.includes(">=250000")
                            ) &&
                            formulaNorm.includes("highvolume") &&
                            formulaNorm.includes("normalvolume")
                        ) {
                            msg = "<span class='excel-result-success'>&#10004; Formula Accepted</span>";
                        }
                            ...
                            msg = "<span class='excel-result-warn'>&#9888; Partial Answer: " + userVal + "</span>";
                        }

                        else {
                            msg = "<span class='excel-result-error'>#ERROR RESULT</span>";
                        }
                    }
                    ...
                    // ---------------- QUESTION 4 ----------------
                        ...
                        let open = parseFloat(getCellFromData(row, 2));   // column C (Open)
                        let close = parseFloat(getCellFromData(row, 5));  // column F (Close)
                        let correctVal = "";
                        ...
                        // Accept =IF(C3<F3,"BUY",IF(C3>F3,"SELL","NEUTRAL")) and minor variations
                        else if (
                            formulaNorm.startsWith("=if(") &&
                            (
                                (
                                    formulaNorm.includes("c3<f3") &&
                                    formulaNorm.includes('"buy"') &&
                                    formulaNorm.includes("c3>f3") &&
                                    formulaNorm.includes('"sell"') &&
                                    formulaNorm.includes('"neutral"')
                                )
                                ||
                                (
                                    formulaNorm.includes("c3<f3") &&
                                ...
                                // Also allow D3-E3 variations if your "Open" or "Close" are elsewhere
                            )
                        ) {
                            msg = "<span class='excel-result-success'>&#10004; Formula Accepted</span>";
                        }
                        // Accept partial answers for only buy/sell/neutral in some form
                        else if (
                            userNorm == "buy" || userNorm == "sell" || userNorm == "neutral"
                        ) {
                            msg = "<span class='excel-result-warn'>&#9888; Partial Answer: " + userVal + "</span>";
                        }
                        else {
        ...
        document.querySelectorAll('.excel-input-sheet').forEach(function(inp) {
            inp.addEventListener('input', function() {
                ...
                let q = Number(document.body.getAttribute('data-question') || 1);
    ...
    if q == 4:
        ...
        excel_col_headers.append(excel_col(len(header) + 1))
    ...
    if q < 2:
        legend_html = "<b>Legend:</b> <span class='excel-green-correct' style='font-weight:normal;'>&#10004;: Correct</span> &nbsp; <span class='excel-warning-calc'>&#9888;: Calculation off</span> &nbsp; <span class='excel-err-msg'>#ERROR TEST</span>"
    elif q == 3:
        ...
        legend_html = (
            ...
            "<span class='excel-err-msg'>#ERROR TEST</span>"
        )
    ...
    <div class="excel-sheet-wrapper" style="width:fit-content;margin:48px auto 20px auto;">
        ...
        <div style="max-width:1100px;width:100%;margin:0 auto;overflow-x:auto;">
            <div style="min-width:1000px;">
                <table class="excel-table-x" aria-label="Excel Stock Table" style="width:100%;table-layout:auto;">
...
# ---- EMAIL HELPER ----
def send_hr_email(candidate_answers, candidate_info=None):
    """
    Send HR email with candidate answers via Resend API.
    """
    import resend

    hr_email = "roopamugappa@gmail.com"
    sender_email = "onboarding@resend.dev"
    subject = "DAX Exam Submitted Answers by Candidate"
    body = f"Candidate Info: {candidate_info or 'N/A'}\n\nSubmitted Answers:\n"
    for k, v in candidate_answers.items():
        body += f"{k}: {v}\n"

    # Prepare elegant HTML for candidate info in table style
    info_html = ""
    if candidate_info and isinstance(candidate_info, dict):
        info_html += "<table style='border-collapse:collapse;border:1px solid #d1e1f1;font-size:15px;font-family:Segoe UI,Arial;margin-bottom:18px;'>"
        for k, v in candidate_info.items():
            info_html += (
                f"<tr><td style='font-weight:600;background:#f3f7fa;padding:8px 18px;border:1px solid #e4eaf3;color:#2772db;'>{k}</td>"
                f"<td style='padding:8px 15px;border:1px solid #e4eaf3;min-width:140px;color:#343f4f;'>{v}</td></tr>"
            )
        info_html += "</table>"
    else:
        info_html += f"<div style='color:#8b8888;font-style:italic;font-size:14px;margin-bottom:8px;'>{candidate_info or 'N/A'}</div>"
    
    # Answers as a pretty table
    answer_html = ""
    if candidate_answers:
        answer_html += "<table style='border-collapse:collapse;border:1px solid #e5e7eb;font-size:15px;font-family:Segoe UI,Arial;'>"
        answer_html += "<tr style='background:#eef7fa;'><th style='padding:6px 21px;border:1px solid #e5e7eb;'>Question</th><th style='padding:6px 18px;border:1px solid #e5e7eb;'>Answer</th></tr>"
        for k, v in candidate_answers.items():
            answer_html += (
                f"<tr>"
                f"<td style='padding:7px 17px;border:1px solid #e5e7eb;color:#022d63;font-weight:520;'>{k}</td>"
                f"<td style='padding:7px 15px;border:1px solid #e5e7eb;color:#1b352c;'>{v}</td>"
                f"</tr>"
            )
        answer_html += "</table>"
    else:
        answer_html = "<div style='color:#999;font-style:italic;'>No answers submitted.</div>"

    html_body = (
        "<div style='font-family:Segoe UI,Arial,sans-serif; font-size:17px; color:#223350; "
        "background:linear-gradient(97deg,#f2f6fb 0,#fafdff 70%); padding:25px 32px 32px 32px; border-radius:17px;'>"
        "<div style='text-align:center;'>"
        "<h2 style='color:#1856b9;letter-spacing:0.5px;margin-bottom:7px;'>DAX Exam Submission</h2>"
        "<div style='color:#4f5a6f;font-size:16.5px;margin-bottom:22px;'><b>Submitted by Candidate</b></div>"
        "</div>"
        "<div style='margin-bottom:13px;padding:12px 0 0 0;'>"
        "<b style='color:#1250a2;'>Candidate Information</b><br>"
        f"{info_html}"
        "</div>"
        "<div style='margin-top:18px;'>"
        "<b style='color:#197853;'>Submitted Answers</b><br>"
        f"{answer_html}"
        "</div>"
        "<div style='font-size:13px;margin-top:32px;text-align:center;color:#a1adc7;'>"
        "&copy; {year} DAX Exam Submission System"
        "</div></div>".format(year=datetime.now().year)
    )

    try:
        resend.api_key = "re_i3U1rY2s_4PzP6ZZFC89Wxqtt9Sizs9xy"
        resend.Emails.send({
            "from": sender_email,
            "to": [hr_email],
            "subject": subject,
...
<div class="container" id="exam-container">
    ...
    <div style="margin-top:32px;">
        ...
        <form id="daxSubmitForm" onsubmit="return submitDaxAnswers(event);">
            ...
            <button type="submit" id="submitBtn">Submit DAX Answers</button>
        </form>
...
// Handler for manual submit or expiry (shared logic, now posts answers)
function submitDaxAnswers(event) {
    ...
    // Optionally you can get candidate info from somewhere, e.g. localStorage or prompt
    fetch('/submit-dax-answers', {
        method: "POST",
        headers: {"Content-Type": "application/json"},
        body: JSON.stringify(answers),
    }).then(res => res.json()).then(data => {
        if (data.status === "ok") {
            document.getElementById("resultBoxDax").innerHTML = "<span style='color:green;font-weight:bold;'>✅ Answers submitted. HR has been notified. Redirecting to dashboard...</span>";
            setTimeout(() => { window.location.href = '/login2'; }, 1400);
        } else {
            document.getElementById("resultBoxDax").innerHTML = "<span style='color:red'>Failed to send to HR. Please contact support.</span>";
        }
    }).catch(e => {
        document.getElementById("resultBoxDax").innerHTML = "<span style='color:red'>Server error. Please try again later.</span>";
    });
    return false;
}
...
def dax_exam_page():
    return HTMLResponse(DAX_PAGE_HTML)


from fastapi import Body
from typing import Dict

@app.post("/submit-dax-answers")
async def submit_dax_answers(data: Dict = Body(...)):
    # Optionally get more candidate info from session/cookies
    sent = send_hr_email(data)
    # HR mail send result returned as JSON.
    if sent:
...
<head>
    ...
    <style>
        ...
        h1 { color: #059669; }
        select, button, textarea { width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ccc; margin-bottom: 10px; font-size: 1rem;}
...
<div class="container" id="mainExamContent" style="display:none;">
    ...
    <div>
        ...
        <ol>
            <li><label>What is the difference between a List and a Tuple in Python?
                <textarea id="q1_open"></textarea></label></li>
            <li><label>How do you create a dictionary in Python?
                <textarea id="q2_open"></textarea></label></li>
            <li><label>What is the output of <code>print(2 ** 3)</code>?
                <textarea id="q3_open"></textarea></label></li>
            <li><label>How do you write a for loop to print numbers from 1 to 5?
                <textarea id="q4_open"></textarea></label></li>
            <li><label>What is the difference between <code>=</code> and <code>==</code> in Python?
                <textarea id="q5_open"></textarea></label></li>
            <li><label>What is the output of <code>len([10, 20, 30])</code>?
                <textarea id="q6_open"></textarea></label></li>
            <li><label>How do you define a function in Python?
                <textarea id="q7_open"></textarea></label></li>
            <li><label>What is the purpose of the <code>import</code> keyword?
                <textarea id="q8_open"></textarea></label></li>
            <li><label>Which data type is returned by <code>input()</code>?
                <textarea id="q9_open"></textarea></label></li>
            <li><label>How do you convert a string like <code>"123"</code> into an integer?
                <textarea id="q10_open"></textarea></label></li>
        </ol>
    </div>
...
function gatherPythonAssessmentAnswers() {
    // Gather MCQ answers
    const mcqs = {};
    for(let i=1;i<=10;i++) {
        mcqs["mcq"+i] = document.getElementById("mcq"+i).value || "";
    }
    // Gather open-ended answers
    const open = {};
    for(let i=1;i<=10;i++) {
        open["q"+i+"_open"] = document.getElementById("q"+i+"_open").value || "";
    }
    return {mcqs: mcqs, open: open};
}

/* MAIN submit for whole assessment AND SEND TO HR */
function submitAllPythonAssessment() {
    if (isPythonExamFinished()) return;
    checkMcqAnswers();

    // Gather answers and POST to backend (/submit-python-answers)
    const answers = gatherPythonAssessmentAnswers();
    markPythonExamFinished();
    document.getElementById('submitAllButton').disabled = true;

    fetch("/submit-python-answers", {
        method: "POST",
        headers: {
...
@app.post("/submit-python-answers")
async def submit_python_answers(data: Dict = Body(...)):
    """
    Receives Python MCQ and open questions answers and sends to HR email.
    """
    # Import send_hr_email if not already imported elsewhere in the file.
    import resend

    # Set your Resend API key
    resend.api_key = "re_i3U1rY2s_4PzP6ZZFC89Wxqtt9Sizs9xy"

    # Format answers in a more professional HTML table
    def format_python_assessment_html(data):
        html = """
        <div style="font-family:Segoe UI,Arial,sans-serif;background:#f7fafc;padding:18px 0;">
          <div style="max-width:650px;margin:0 auto;background:#fff;border-radius:10px;box-shadow:0 3px 18px #e5eaf5;padding:36px;">
            <h2 style="color:#2563eb;font-weight:bold;margin-top:0;font-size:1.5em;margin-bottom:16px;">
                🐍 Python Assessment Submission
            </h2>
            <table style="width:100%;border-collapse:collapse;margin-bottom:20px;font-size:15px;">
              <thead>
                <tr style="background:#f1f5fa;color:#285693;">
                  <th style="padding:8px 10px;border:1px solid #e3e6ec;">Question</th>
                  <th style="padding:8px 10px;border:1px solid #e3e6ec;">Answer</th>
                </tr>
              </thead>
              <tbody>
        """
        for section in ["mcqs", "open"]:
            section_data = data.get(section, {})
            for k, v in section_data.items():
                key_label = k.replace("mcq", "MCQ ").replace("_open", "").replace("q", "Q").replace("_", " ")
                html += f"""
                  <tr>
                    <td style="padding:8px 12px;border:1px solid #e3e9f6;font-weight:500;background:#fcfdff;">{key_label}</td>
                    <td style="padding:8px 12px;border:1px solid #e3e9f6;background:#f8fafc;color:#283854;">{v if v.strip() else "<i>No answer provided</i>"}</td>
                  </tr>
                """
        html += """
              </tbody>
            ...
            <div style="font-size:13px;color:#9ba5bc;margin-top:24px;border-top:1.5px solid #f1f4fc;padding-top:12px;">
                <strong>Candidate Submission</strong> &mdash; Python Assessment<br>
                <span style="color:#6081b1;">This email was generated automatically by the assessment platform.</span>
            </div>
          </div>
        </div>
        """
    ...
    html_body = format_python_assessment_html(data)

    sent = resend.Emails.send({
        "from": "onboarding@resend.dev",
        "to": ["roopamugappa@gmail.com"],
        "subject": "Python Assessment Submission",
        "text": "Python Assessment Submission:\n" + str(data),
        "html": html_body,
    })
    # HR mail send result returned as JSON.
    if sent:
...
<div class="container">
    ...
    <div>
        ...
        <form id="charts-answer-form" method="POST" action="/charts/submit" onsubmit="return handleChartsFormSubmit(event);">
        <div class="question">
            <b>1. Write your own analysis question (Example: "Which sector had the highest total P/L?"):</b><br>
            <input type="text" id="customChartQuestion" name="customChartQuestion" style="width:90%;" placeholder="Enter your chart analysis question here">
        </div>
        <div class="question">
        ...
        <div class="question">
            ...
            <textarea id="customChartObservation" name="customChartObservation" style="width:95%;" rows="3" placeholder="Write your answer or insights from the chart"></textarea>
        </div>
        <div class="question">
            ...
            <div>
                <input type="text" id="chartTask2Question" name="chartTask2Question" style="width:75%;" placeholder="Enter your second chart analysis question">
                <textarea id="chartTask2Observation" name="chartTask2Observation" style="width:75%;margin-top:5px;" rows="2" placeholder="Your answer or observation about this chart"></textarea>
            </div>
            <div>
                <input type="text" id="chartTask3Question" name="chartTask3Question" style="width:75%;" placeholder="Enter your third chart analysis question">
                <textarea id="chartTask3Observation" name="chartTask3Observation" style="width:75%;margin-top:5px;" rows="2" placeholder="Your answer or observation about this chart"></textarea>
            </div>
        </div>
        <input type="hidden" id="charts-answers-timestamp" name="charts-answers-timestamp">
        <button class="submit-btn" id="charts-submit-btn-form" type="submit">Submit Answers</button>
        </form>
    </div>
</div>
<script>
...
function showAlreadySubmittedMessage() {
    ...
    document.getElementById('charts-submit-btn-form').disabled = true;
}

function handleChartsFormSubmit(e) {
    e.preventDefault();
    // Optionally validate here if needed

    // Set timestamp for submission
    document.getElementById("charts-answers-timestamp").value = new Date().toISOString();

    var fd = new FormData(document.getElementById("charts-answer-form"));
    fetch("/charts/submit", {
        method: "POST",
        body: fd
    })
    ...
    .then(data => {
        ...
        setTimeout(()=>window.location.href="/login2", 1200);
    });
    return false;
}
...
function chartsTickTimer() {
    ...
    if(timeLeftSec <= 0) {
        if (!isChartsExamFinished()) {
            document.getElementById("charts-answers-timestamp").value = new Date().toISOString();
            document.getElementById("charts-answer-form").requestSubmit();
        }
        return;
    }
}
...
# --- BACKEND submit route for charts answers, also emails HR ---

from fastapi import APIRouter

@app.post("/charts/submit")
async def charts_submit(
    request: Request,
    customChartQuestion: str = Form(""),
    customChartObservation: str = Form(""),
    chartTask2Question: str = Form(""),
    chartTask2Observation: str = Form(""),
    chartTask3Question: str = Form(""),
    chartTask3Observation: str = Form(""),
    charts_answers_timestamp: str = Form("")
):
    # You can get user info from cookies/session/login if implemented, for now anonymous
    user = request.cookies.get("user", "unknown")
    answers_text = f"""Trading Charts Assessment Submission

Submitted by: {user}
Timestamp: {charts_answers_timestamp}

1. Custom Chart Question:
{customChartQuestion}

Observation/Answer:
{customChartObservation}

2. Second Chart Question:
{chartTask2Question}

Observation/Answer:
{chartTask2Observation}

3. Third Chart Question:
{chartTask3Question}

Observation/Answer:
{chartTask3Observation}

"""
    # Send email to HR (adjust HR_EMAIL and from details accordingly!)
    try:
        import resend
        # Ideally, use environment variables for API keys/emails in production
        resend.api_key = "re_i3U1rY2s_4PzP6ZZFC89Wxqtt9Sizs9xy"

        HR_EMAIL = "roopamugappa@gmail.com"
        FROM_EMAIL = "onboarding@resend.dev"

        email_subject = "Trading Charts Assessment Submission"

        # Modern, clean, professional Card-UI style email body
        email_body_html = f"""
        <div style="background: linear-gradient(108deg, #f7faff 0%, #eaf1fd 80%); font-family:'Segoe UI', Arial,sans-serif; min-width:320px; color:#213043; padding:0; margin:0;">
          <div style="max-width:640px;margin:44px auto 32px auto;background:#fff;box-shadow:0 8px 32px rgba(51,70,128,0.09);border-radius:18px;overflow:hidden;">
            <div style="background:linear-gradient(90deg, #1856b9 10%, #43c6ac 100%);padding:30px 36px 18px 36px;color:#fff;">
              <h1 style="margin:0;font-size:2.1em;letter-spacing:1px;font-weight:700;">Trading Charts Assessment</h1>
              <div style="margin-top:12px;font-size:1.19em;font-weight:400;">
                <span style="opacity:0.90;">Candidate Submission</span>
              </div>
            </div>
            <div style="padding:30px 36px 16px 36px;">
              <div style="margin-bottom:20px;">
                <span style="color:#595c66;font-size:1.06em;">Submitted by:</span>
                <span style="font-weight:600;color:#1856b9;">{user}</span>
                <span style="margin-left:22px;color:#8b949e;">Timestamp:</span>
                <span style="font-family:monospace;color:#065b32;">{charts_answers_timestamp}</span>
              </div>
              <hr style="border:none;border-top:1.5px solid #f3f4f9;margin-bottom:36px;">
              <div style="margin-bottom:10px;color:#234;">Below are the answers submitted by the candidate:</div>
              <div style="background:#f6fafc;border-radius:12px;border:1.5px solid #edecfc;padding:20px 24px;margin-bottom:18px;font-size:1.04em;">
                <pre style="margin:0;font-size:15.5px;white-space:pre-wrap;word-break:break-word;background:transparent;border:none;padding:0;color:#22334e;line-height:1.6;">{answers_text}</pre>
              </div>
              <div style="color:#929dac;font-size:0.97em; margin-top:35px;text-align:center;border-top:1px solid #eaf1fd; padding-top:13px;">
                This report was generated automatically by the candidate assessment platform.<br>
                For queries, please contact <a href="mailto:support@company.com" style="color:#1856b9;text-decoration:none;">support@company.com</a>.
              </div>
            </div>
          </div>
          <div style="text-align:center;font-size:1em;color:#8696ac;margin:24px 0 4px 0;font-family:Segoe UI,Arial;">
            &copy; {user if user!='unknown' else 'Analytics Platform'} &mdash; {charts_answers_timestamp[:10]}
          </div>
        </div>
        """
        ...
        # Optionally log this!
        print("Charts/Email send error", str(e))
